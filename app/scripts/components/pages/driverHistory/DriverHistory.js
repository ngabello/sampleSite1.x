...
function DriverHistoryCtrl() {

  return ['$scope', '$stateParams', '$log', 'QuoteIntentModel', 'ModelHelper', 'JourneyService', 'radioChoices', 'segmentIoTrackingService', 'IncidentService','LookupDataService',
    function ($scope, $stateParams, $log, quoteIntentModel, modelHelper, journeyService, radioChoices, segmentIoTrackingService, incidentService, lookupDataService) {
      ...
      var updateDriver = function () {
        ...
        if ($scope.driverHistoryCtrlState.addIncident.selected == true) {
          ...
          if (incidentService.validateIncidents()) {
            ...
            journeyService.getNextStep($scope.driverHistoryCtrlState.convictionQuestion, null);
          } else {
